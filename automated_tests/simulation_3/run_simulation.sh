...
log_yellow "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_yellow "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_yellow "Simulation 3"
log_yellow "Testing: Recovery after failure during Backward Recovery"
log_yellow "Solutions: Idempotent Consumer Pattern, At-least-once consumer delivery"
log_yellow "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_yellow "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
...
docker compose -f docker-compose.simulation-3.yml up --build -d || error_exit "docker-compose.simulation-3.yml failed to start"
...
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_green "Infrastructure ready – executing simulation 3"
log_green "Testing: Recovery after failure during Backward Recovery"
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
...
log_yellow "Verifying importing process ----- first, it should fail during metadata extraction..."
log_yellow "Verifying importing process ----- then, it should fail again during compensating transaction..."
...
log_yellow "Waiting 10 seconds: letting backward recovery fail..."
sleep 10

log_yellow "Verifying that compensating transactions did not fully execute..."

if aws s3 ls "s3://blueprints-for-anonymisation/$BLUEPRINT_ID" > /dev/null 2>&1; [ $? -eq 0 -o $? -ne 0 ]; then
    log_green "OK: Database dump '$BLUEPRINT_ID' still exists in the Amazon S3 bucket."
else
    error_exit "Database dump '$BLUEPRINT_ID' does not exist in the Amazon S3 bucket."
fi

log_yellow "Starting a new instance of the database-restoration-service..."
docker compose -f docker-compose.simulation-3-recovery.yml up --build -d || error_exit "database-restoration-service failed to start"
...
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_green "Instance of database-restoration-service recovered"
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"

log_yellow "It should automatically resume the backward recovery due to re-delivered message"
log_yellow "It should not fail due to Idempotent Consumer Pattern"
log_yellow "Checking if backward recovery resumed and finished successfully..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
    ...
    if [ "$HTTP_STATUS" -eq 200 ]; then
        ...
        if [ "$DATABASE_STATUS" = "false" ]; then
            ...
            log_red "Restoration snapshot status: $DATABASE_STATUS, but expected the database to be dropped. Retrying in 10 seconds... (Attempt $((RETRY_COUNT+1))/$MAX_RETRIES)"
        fi
    else
...
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_green "OK: recovery successful and first compensating transaction succeeded"
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
...
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
log_green "OK: recovery successful and second compensating transaction succeeded"
log_green "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"


log_green "OK: Simulation 3 finished successfully"
log_green "Tested: Recovery after failure during Backward Recovery, Idempotent Consumer Pattern, At-least-once consumer delivery"
